                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="app-card col-xs-12">
                            <img class="app-img click" id="<%=ds.Tables["Type"].Rows[i][0].ToString() %>" src="img/<%=ds.Tables["Type"].Rows[i][1].ToString() %>" />
                            <small class="col-md-12 col-xs-12 app-name tldr"><%=ds.Tables["Type"].Rows[i][4].ToString() %></small>
                            <cite class=" col-md-12 col-xs-12 caption tldr"><%=ds.Tables["Type"].Rows[i][5].ToString() %></cite>
                        </div>
                        <% } %>
                    </div>
                </div>
